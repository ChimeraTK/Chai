...
from textual.containers import Horizontal, Widget, Container, Grid
    ...
    def update(self) -> None:
        ...
        if self._isRaw:
            ...
            for element, value in enumerate(self._register[self._channel]):
                table.add_row(self._register.getAsCooked(str, self._channel, element),
                              value, hex(value), label=str(element))
        else:
